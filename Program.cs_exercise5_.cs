...
static void showWelcomeMessage()
{
    ...
    {
        Console.Write("welcome! What's your name, adventure ?");
    ...
    {
        Console.Write("What's your lucky number of the day?");
    ...
    {
        Console.WriteLine($" {playerN}, your power number is {powernumber} , your doing great , come back later for a new number" );
    }
